...
public class AStarSearch {
    ...
    public AStarSearch(int data[][], int goal) {
        ...
        while (true) {
            ...
            for (int i = 0; i < this.map.length; i++) {
                if (this.map[temp.state.city][i] > 0) {
                    ...
                    node.huristicCost = node.pathCost + huristicCost(i);
                    ...
                    if (!explored.contains(node)) {
                        ...
                        if (frontier.contains(node)) {
                            ...
                            while (itr.hasNext()) {
                                ...
                                if (tempNode.state.equals(node.state)) {
                                    if (tempNode.pathCost > node.pathCost) {
                                        tempNode.pathCost = node.pathCost;
                                        tempNode.parent = node.parent;
                                        tempNode.huristicCost = node.huristicCost;
                                    }
                                    break;
                                }
                            }
    ...
    public static void main(String[] args) {
        ...
        AStarSearch bfs = new AStarSearch(map, 1);
